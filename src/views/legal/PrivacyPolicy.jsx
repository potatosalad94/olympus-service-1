	...
	const content = {
		en: (
			<>
				...
				<p>
					If you contact customer support you may be asked to share
					the following additional information which may be passed to
					us to help process your enquiry.
				</p>
				<ul>
					...
					<li>
						Any other contact details provided to us by you
						including in email signatures
					</li>
				</ul>

				<p>
					If you are a Customer then your mobile network operator may
					have passed to us some or all of the above data which we
					shall hold securely and use solely in accordance with this
					Privacy Policy.
				</p>
				...
				<p>
					...
					technology that helps us assess the risk associated with an
					attempted transaction that is enabled on the Merchant's
					website or the application that collects information.
				</p>
		...
		ar: (
			<>
				...
				<p>
					البيانات الشخصية التي نقوم بجمعها عنك تُستخدم فقط لتقديم
					الخدمة ولاستخدامها ضروري لهذا الغرض. وقد نجمع بعض أو جميع
					المعلومات التالية:
				</p>
				<ul>
					<li>
						رقم هاتفك المحمول (وقد يتم الحصول عليه تلقائيًا من مزود
						خدمة الشبكة إذا اخترت الدفع عبره)
					</li>
					<li>
						معلومات حول متصفحك و/أو جهازك، بما في ذلك البيانات
						الوصفية المتصلة مثل اللغة والإعدادات المحلية
					</li>
					<li>
						مزود خدمة شبكة الهاتف المحمول أو معرفات الاتصال بالشبكة
					</li>
					<li>مبلغ الفاتورة، وصف المنتج، واسم التاجر</li>
				</ul>

				<p>وبحسب نوع الخدمة، قد نجمع أيضًا:</p>
				<ul>
					<li>عنوان بريدك الإلكتروني</li>
					<li>رقم هاتفك للتواصل</li>
				</ul>

				<p>
					إذا تواصلت مع دعم العملاء، قد يُطلب منك مشاركة المعلومات
					التالية والتي قد يتم تمريرها إلينا لمعالجة استفسارك:
				</p>
				<ul>
					<li>اسمك الكامل</li>
					<li>عنوان بريدك الإلكتروني</li>
					<li>عنوان سكنك أو عنوان عملك</li>
					<li>
						أي تفاصيل اتصال أخرى تقدمها لنا، بما في ذلك التوقيع في
						رسائل البريد الإلكتروني
					</li>
				</ul>

				<p>
					إذا كنت عميلاً، فقد يكون مزود شبكة الهاتف المحمول الخاص بك
					قد زودنا ببعض أو كل البيانات أعلاه، والتي سنقوم بحفظها بأمان
					واستخدامها فقط وفقًا لسياسة الخصوصية هذه.
				</p>

				<p>
					عند تنفيذ أنشطة كشف الاحتيال ومراقبته والوقاية منه، قد نتلقى
					أيضًا بيانات شخصية عنك من شركائنا التجاريين، مزودي الخدمات
					المالية، خدمات التحقق من الهوية، والمصادر المتاحة علنًا
